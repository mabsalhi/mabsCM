...
package com.mabscm.cmweb.web.util;

import com.mabscm.cmentities.model.Personne;
import com.mabscm.cmweb.ejb.PersonneFacade;
import com.mabscm.cmweb.web.PersonneController;
                ...
                for (Part part : request.getParts()) {
                    ...
                    if (!EXTENSIONS_ALLOWED.contains(extension)) {
                        ...
                        response.sendRedirect(
                                "personne/List.xhtml?errMsg=Error trying to upload file");
                    ...
                    personne.setPhoto(b);
                    personneBean.edit(personne);

                    response.sendRedirect("personne/list.xhtml");
                }
            } else {
                // no img case
                response.sendRedirect("personne/list.xhtml");
